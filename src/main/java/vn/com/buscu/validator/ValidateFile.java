...
public class ValidateFile {
    ...
    public static boolean validate(Product check) {
        ...
        for (int i = 0; i < BuscuConst.VAL_7; i++) {
            ...
            boolean checksaleRank = validateDate(product.getSaleRank());
            boolean checkimage1 = validatePhone(product.getImage1());
            ...
            if (checkCode == false) {
                ...
                checkFlg = false;
            } else if (checksaleRank == false){
                checkFlg = false;
            } else if (checkimage1 == false){
                checkFlg = false;
            } else {
                checkFlg = true;
            }
